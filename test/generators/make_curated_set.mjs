 ...
 *
 * Run: node test/generators/make_curated_set.mjs   (exit 0 = pass, 1 = fail)
 */
...
for (const entry of REGISTRY) {
  ...
  const summary = [
    ...
    `Rights: ${entry.rights}`,
    `Generated by: node test/generators/make_curated_set.mjs (engine-only, every edit an offset splice)`,
    "",
    "## Curation steps",
    "",
...
const setTable = [
  ...
  "Regenerate with: node test/generators/make_curated_set.mjs",
