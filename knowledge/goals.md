...
- ( ) **M2.9** teiCrafter-internal storage for edited TEIs (operator announcement 2026-06-10: "Wir werden wahrscheinlich eine teiCrafter interne Ablage bauen"). Save-in-place via the File System Access handle already works for opened files; the internal store (candidates: Origin Private File System, a directory handle the user grants once) is undesigned. Not started; needs an operator design decision.
