...
docs/
  ...
  js/
    editor/
      ...
      project-manifest.js Declarative project manifest (teicrafter.project.json): entry-agnostic parse/validate, normalizes to the same runtime project shape; documentTypes + files bind the markup inventory to a file's edition type
