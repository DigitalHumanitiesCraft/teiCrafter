...
- Upstream project: <https://github.com/jameslan/libxml2-wasm>
- Licence: MIT, reproduced in `LICENSE.txt`

The package is copied without modification so its relative ES-module imports
and embedded WebAssembly payload remain reproducible.
